...
//   // Clear filtered tests on unmount
//   useEffect(() => {
//     return () => {
//       clearFilteredVehi()
//     }
...
//   const clearFilteredVehi = useVehicleStore(s => s.clearFilteredVehi)
//   const removeFilteredTest = useVehicleStore(s => s.removeFilteredTest)
// const currentVehicleFN=useVehicleStore(s=>s.getVehicleDetails);
...
//     }
//   }, [clearFilteredVehi])
//   useEffect(()=>{currentVehicleFN(bookingId)},[currentVehicleFN,bookingId])
// console.log(Object.keys(currentVehicle).length);
...
//           Search
//         </button>
//         <div className='p-6 bg-amber-100'></div>
//         {currentVehicle?.length > 0 && currentVehicle.map(v => (
//   <div key={v._id} className='text-black'>{console.log(v.regnNo)}</div>
// ))}
...
//                 />
//               ) : (
//                 // ✅ Approve/Reject for visualTestSchema
//                 <div className="flex gap-2">
//                   <button
//                     onClick={() => handleSubmit(code, true)}
//                     className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded"
